...
abstract class AbstractFindTargetGreedy implements FindTargetStrategy {
  ...
  protected void setPotentialTargets(
      @Nonnull Collection<DatanodeUsageInfo> pt
  ) {
    potentialTargets = pt;
  }

  protected int compareByUsage(
      @Nonnull DatanodeUsageInfo a,
      @Nonnull DatanodeUsageInfo b
  ) {
