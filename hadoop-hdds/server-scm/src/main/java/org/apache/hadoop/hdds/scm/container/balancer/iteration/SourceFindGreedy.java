 ...
 */
public class SourceFindGreedy implements FindSourceStrategy {
  private static final Logger LOG =
      LoggerFactory.getLogger(SourceFindGreedy.class);
  ...
  public SourceFindGreedy(@Nonnull NodeManager nodeManager) {
